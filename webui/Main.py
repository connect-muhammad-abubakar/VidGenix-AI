...
st.set_page_config(
    page_title="VidGenix AI",
    page_icon="🤖",
    layout="wide",
    initial_sidebar_state="auto",
    menu_items={
        "Report a bug": "https://github.com/harry0703/VidGenix AI/issues",
        "About": "# VidGenix AI\nSimply provide a topic or keyword for a video, and it will "
        "automatically generate the video copy, video materials, video subtitles, "
        "and video background music before synthesizing a high-definition short "
        "video.\n\nhttps://github.com/harry0703/VidGenix AI",
    },
)
...
with title_col:
    st.title(f"VidGenix AI v{config.project_version}")
                ...
                with llm_helper:
                    tips = """
                            ...
                            - **Base Url**: 一般为 http://localhost:11434/v1
                                - 如果 `VidGenix AI` 和 `Ollama` **不在同一台机器上**，需要填写 `Ollama` 机器的IP地址
                                - 如果 `VidGenix AI` 是 `Docker` 部署，建议填写 `http://host.docker.internal:11434/v1`
